...
const categoryEmoji: Record<string, string> = {
  offer: '↑', request: '↓', observation: '◆', event: '⟷',
};
...
function createPinIcon(category: string) {
  ...
  return L.divIcon({
    html: `<div style="width:28px;height:28px;border-radius:8px;background:${color};display:flex;align-items:center;justify-content:center;color:hsl(40,20%,85%);font-size:14px;font-weight:bold;box-shadow:0 0 12px ${color}88;border:2px solid ${color}cc;">${categoryEmoji[category] || '•'}</div>`,
    className: '',
    iconSize: [28, 28],
    iconAnchor: [14, 14],
  });
