...
export default function StreetMapView({
  ...
  return (
    <div className="w-full h-full" style={{ zIndex: 0 }}>
      ...
      >
        {streetOpacity > 0.2 && <span>Streets: <a href="https://stamen.com" target="_blank" rel="noopener" className="underline hover:text-foreground/60">Stamen</a> / <a href="https://www.openstreetmap.org" target="_blank" rel="noopener" className="underline hover:text-foreground/60">OSM</a></span>}
