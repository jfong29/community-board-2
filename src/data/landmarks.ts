...
export const landmarks: Landmark[] = [
  ...
  // ── Lenape Heritage Sites (from 6sqft) ──
  {
    id: 'bowling-green',
    name: 'Council Elm',
    icon: '🌳',
    x: 0, y: 0,
    lat: 40.7042, lng: -74.0138,
    description: 'Bowling Green — NYC\'s oldest park — was home to the Kapsee chief and a sacred Council Elm where Lenape held Council Fires, orators spoke, and people traded. The 1626 "trade" between the Lenape and the Dutch reportedly took place under this tree.',
    source: '6sqft: Mapping Manahatta; NMAI',
    pins: [
      { category: 'observation', title: 'Council Elm Heritage Marker', description: 'Site of the original Lenape Council Elm. The National Museum of the American Indian now occupies the nearby Alexander Hamilton Customs House.', subcategory: 'Heritage', distance: 'On site', postedBy: '6sqft / Lenape Heritage', isAutoGenerated: true, sourceOrg: 'National Museum of the American Indian', sourceUrl: 'https://americanindian.si.edu/visit/newyork/' },
    ],
  },
  {
    id: 'pearl-street',
    name: 'Pearl Street Midden',
    icon: '🦪',
    x: 0, y: 0,
    lat: 40.7070, lng: -74.0030,
    description: 'Pearl Street began as a Lenape oyster midden along the East River. Since New York Harbor was home to half the world\'s oysters, shells were piled several feet high. The Dutch named the street for the discarded pearls found among the shells.',
    source: '6sqft: Mapping Manahatta; NYPL',
    pins: [
      { category: 'observation', title: 'Oyster Heritage Site', description: 'The original shoreline and oyster beds once extended to this line. Pearl Street was literally paved with oyster shells.', subcategory: 'Heritage', distance: 'On site', postedBy: '6sqft / Lenape Heritage', isAutoGenerated: true, sourceOrg: '6sqft / Lenape Heritage', sourceUrl: 'https://www.6sqft.com/mapping-manahatta-10-lenape-sites-in-new-york-city/' },
    ],
  },
  {
    id: 'kintecoying',
    ...
    icon: '⚡',
    x: 0, y: 0,
    lat: 40.7299, lng: -73.9909,
    description: 'Today\'s Astor Place was "Kintecoying," a major inter-tribal crossroads where Manahatta\'s three Lenape groups — the Canarsie, Sapohannikan, and Manhattan — converged for meetings, councils, games, trade, and burials. In 1870, Chief Red Cloud continued this tradition of Native American oratory from the stage at Cooper Union.',
    source: '6sqft: Mapping Manahatta; Cooper Union Archives',
    pins: [
      { category: 'event', title: 'Stories at the Crossroads', description: 'Monthly storytelling evening continuing the tradition of oratory at this ancient crossroads. Open mic format.', subcategory: 'Gathering', distance: 'Cooper Union', postedBy: 'Lenape Heritage Circle', isAutoGenerated: true, sourceOrg: 'Cooper Union', sourceUrl: 'https://www.6sqft.com/mapping-manahatta-10-lenape-sites-in-new-york-city/' },
    ],
  },
  {
    id: 'cherry-orchard',
    ...
    icon: '🍒',
    x: 0, y: 0,
    lat: 40.7110, lng: -73.9960,
    description: 'Cherry Street marks the edge of the Lenape\'s vast cherry orchard. George Washington lived at 1 Cherry Street — the nation\'s first presidential residence. Traces of the orchard survived into the 1870s, when the last trees were swept away to build the Brooklyn Bridge.',
    source: '6sqft: Mapping Manahatta; NYPL',
    pins: [
      { category: 'offer', title: 'Heritage Cherry Saplings', description: 'Saplings grown from heritage cherry stock, connecting to the Lenape orchard tradition. Free to community gardeners.', subcategory: 'Seeds', distance: 'On site', postedBy: 'LES Ecology Center', isAutoGenerated: true, sourceOrg: 'LES Ecology Center', sourceUrl: 'https://www.lesecologycenter.org' },
    ],
  },
  {
    id: 'konaanderkongh',
    ...
    icon: '🏕️',
    x: 0, y: 0,
    lat: 40.7858, lng: -73.9520,
    description: 'Near Park Avenue and 98th Street, several hundred Lenape people gathered at a seasonal basecamp for hunting and gathering called Konaanderkongh. The tradition of gathering continues — the Park Avenue Armory hosts cultural events nearby.',
    source: '6sqft: Mapping Manahatta',
    pins: [
      { category: 'observation', title: 'Seasonal Basecamp Site', description: 'Archaeological indicators suggest this was a major seasonal camp where hundreds gathered. The terrain still slopes toward the original hunting grounds of Central Park.', subcategory: 'Heritage', distance: 'On site', postedBy: '6sqft / Lenape Heritage', isAutoGenerated: true, sourceOrg: '6sqft / Lenape Heritage', sourceUrl: 'https://www.6sqft.com/mapping-manahatta-10-lenape-sites-in-new-york-city/' },
    ],
  },
...
// Compute x/y for landmarks that only have lat/lng
import { latLngToXY } from './pins';
landmarks.forEach(lm => {
  if (lm.x === 0 && lm.y === 0 && lm.lat && lm.lng) {
    const coords = latLngToXY(lm.lat, lm.lng);
    lm.x = coords.x;
    lm.y = coords.y;
  }
});
